...
local function SetNormalPig(inst)
    ...
    inst.components.combat:SetDefaultDamage(TUNING.BTWS_PIGMAN_DAMAGE)
    inst.components.combat:SetAttackPeriod(TUNING.BTWS_PIGMAN_ATTACKSPEED)
    inst.components.combat:SetKeepTargetFunction(NormalKeepTargetFn)
    inst.components.locomotor.runspeed = TUNING.BTWS_PIGMAN_RUNSPEED
    inst.components.locomotor.walkspeed = TUNING.BTWS_PIGMAN_WALKSPEED
    ...
    inst.components.health:SetMaxHealth(TUNING.BTWS_PIGMAN_HEALTH)
...
local function common(moonbeast)
    ...
    inst:DoTaskInTime(TUNING.BTWS_PIGMAN_DURATION, RemovePig)
...
return Prefab("pigman_wes", normal, assets, prefabs)
