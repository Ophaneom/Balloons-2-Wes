...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "spiderballoon_icon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/spiderballoon_icon.xml"
    -----------------------------------

    inst:AddComponent("inspectable")

    inst:AddComponent("criarbalao")
    inst.components.criarbalao:TrocarPrefab("_spider")
...
return Prefab("balloons_empty_spider", fn, assets, prefabs)
