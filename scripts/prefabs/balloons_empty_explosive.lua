...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "explosiveballoon_icon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/explosiveballoon_icon.xml"
    -----------------------------------

    inst:AddComponent("inspectable")

    inst:AddComponent("criarbalao")
    inst.components.criarbalao:TrocarPrefab("")
...
return Prefab("balloons_empty_explosive", fn, assets, prefabs)
