...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "pigmanballoon_icon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/pigmanballoon_icon.xml"
    -----------------------------------

    inst:AddComponent("inspectable")

    inst:AddComponent("criarbalao")
    inst.components.criarbalao:TrocarPrefab("_pig")
...
return Prefab("balloons_empty_pig", fn, assets, prefabs)
