...
local function RemoveKing(inst)
...
local function onload(inst, data)
    if data ~= nil and data.exists then
        inst:DoTaskInTime(1, RemoveKing)
    end
end
...
local function fn()
    ...
    inst:DoTaskInTime(TUNING.BTWS_PIGKING_DURATION, RemoveKing)
...
return Prefab("pigking_wes", fn, assets, prefabs)
